...
export function ProviderProfileScreen({
  ...
  // Basic Details
  const [firstName, setFirstName] = useState("Dr. John");
  const [lastName, setLastName] = useState("Smith");
  const [email, setEmail] = useState("provider@clinic.com");
  const [phone, setPhone] = useState("+1 (555) 123-4567");
  const [specialization, setSpecialization] = useState("Chiropractor");
  const [licenseNumber, setLicenseNumber] = useState("CHI123456");
          ...
          <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl">
            <form onSubmit={handleSave}>
              ...
              <div className="p-6 space-y-6">
                ...
                <h2 className="text-sm font-semibold text-neutral-900 dark:text-white pt-4">
                  Professional information
                </h2>
