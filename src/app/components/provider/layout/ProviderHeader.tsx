...
export function ProviderHeader({
  ...
  return (
    <>
        ...
        <div className="h-full max-w-[1600px] mx-auto px-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="md:hidden p-2 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-lg transition-colors ml-1"
            >
              {isMobileMenuOpen ? (
      ...
      {isMobileMenuOpen && (
        <div className="fixed top-16 left-0 right-0 bottom-0 bg-white dark:bg-neutral-950 z-40 md:hidden overflow-y-auto">
