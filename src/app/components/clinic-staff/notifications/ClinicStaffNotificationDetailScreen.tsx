...
import { ArrowLeft, Calendar, FileText, Bell, Download, CheckCircle, ExternalLink, Users, AlertCircle } from "lucide-react";
...
interface ClinicStaffNotificationDetailScreenProps {
...
export function ClinicStaffNotificationDetailScreen({
  notification,
  onNavigate,
  onBack,
  onMarkAsRead,
  ...
  onLogout,
  onNavigateToProfile,
}: ClinicStaffNotificationDetailScreenProps) {
  ...
  return (
    <ClinicStaffLayout activeMenu="dashboard" onNavigate={onNavigate} onLogout={onLogout} onNavigateToProfile={onNavigateToProfile}>
      <div className="p-6">
        {/* Back Button */}
        <button
          onClick={onBack}
