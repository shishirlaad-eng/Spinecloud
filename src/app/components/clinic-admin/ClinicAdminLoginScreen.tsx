...
interface ClinicAdminLoginScreenProps {
  onLoginSuccess: () => void;
...
export function ClinicAdminLoginScreen({
  onLoginSuccess,
  onNavigateToRegister,
  onNavigateToForgotPassword,
  successMessage,
}: ClinicAdminLoginScreenProps) {
      ...
      <div className="hidden lg:flex lg:w-5/12 bg-gradient-to-br from-primary-600 to-primary-700 p-12 flex-col justify-between">
        <div>
          ...
          <p className="text-primary-100 text-sm leading-relaxed">
            Sign in to your clinic admin account to manage appointments, patients, and healthcare delivery.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-white font-medium text-sm mb-1">Streamlined operations</h3>
              <p className="text-primary-100 text-sm">Manage your entire clinic from one platform</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center flex-shrink-0">
            ...
            <div>
              <h3 className="text-white font-medium text-sm mb-1">Real-time updates</h3>
              <p className="text-primary-100 text-sm">Stay informed with instant notifications</p>
            </div>
          </div>
        </div>
      </div>
