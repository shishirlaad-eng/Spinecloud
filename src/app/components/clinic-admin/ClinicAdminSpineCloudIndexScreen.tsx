...
import { Search, Filter, TrendingUp, TrendingDown, Minus, Calendar, User, ChevronRight, Settings } from "lucide-react";
...
interface ClinicAdminSpineCloudIndexScreenProps {
...
export function ClinicAdminSpineCloudIndexScreen({
  onNavigate,
  onViewDetails,
  onNavigateToConfig,
  onLogout,
  onNavigateToProfile,
}: ClinicAdminSpineCloudIndexScreenProps) {
  ...
  // Mock data - all patients' SpineCloud assessments
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-neutral-600 dark:text-neutral-400 mt-1">
              View and track all patients' wellness assessments
            </p>
          </div>
          <button
