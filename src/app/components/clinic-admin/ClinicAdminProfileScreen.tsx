...
interface ClinicAdminProfileScreenProps {
...
export function ClinicAdminProfileScreen({
  onNavigate,
  onLogout,
}: ClinicAdminProfileScreenProps) {
  ...
  const [role, setRole] = useState("Clinic Administrator");
  const [organizationName, setOrganizationName] = useState("SpineCloudIQ Clinic");
