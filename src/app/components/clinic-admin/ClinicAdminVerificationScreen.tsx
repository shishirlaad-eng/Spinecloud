...
interface ClinicAdminVerificationScreenProps {
  email: string;
...
export function ClinicAdminVerificationScreen({
  email,
  context,
  onSuccess,
  onBack,
}: ClinicAdminVerificationScreenProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isFormValid()) {
      const message = context === "register" 
      ...
      <div className="hidden lg:flex lg:w-5/12 bg-gradient-to-br from-primary-600 to-primary-700 p-12 flex-col justify-between">
        <div>
          ...
          <h2 className="text-2xl font-semibold text-white mb-4">
            {context === "register" ? "Verify your email" : "Reset your password"}
          </h2>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-neutral-900 dark:text-white mb-2">
              {context === "register" ? "Verify email & set password" : "Reset password"}
            </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="password" className="text-sm text-neutral-700 dark:text-neutral-300 font-medium block mb-1.5">
                {context === "register" ? "Create password" : "New password"} <span className="text-destructive">*</span>
              </label>
            ...
            >
              {context === "register" ? "Create password" : "Reset password"}
            </button>
          </form>
        </div>
      </div>
